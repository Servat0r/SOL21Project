...
# lock a file and unlock it after 200 milliseconds; another client tries to lock it but has to wait
bin/client -p -t 200 -f bin/tmp/serverSocket.sk -l ${SCRIPTPATH}/test1files/file2 -u ${SCRIPTPATH}/test1files/file2 &
